...
| `server/modules/api-foundation` | Shared API contracts and transport-neutral HTTP primitives               | Library JAR         |
| `server/modules/auth`           | Users, groups, roles, Statements, and authorization policy enforcement   | Library JAR         |
