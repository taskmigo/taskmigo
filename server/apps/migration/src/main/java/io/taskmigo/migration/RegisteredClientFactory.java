...
final class RegisteredClientFactory {
    ...
    private static void validateBrowser(
        ...
        if (!Set.of("openid", "profile", BrowserClientMetadata.API_SCOPE).equals(registration.getScopes())) {
    ...
    private static void validateInternal(
        ...
        if (!Set.of(BrowserClientMetadata.API_SCOPE).equals(registration.getScopes())) {
