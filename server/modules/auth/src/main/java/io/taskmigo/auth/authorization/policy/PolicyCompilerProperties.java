...
import io.taskmigo.policy.CompilerLimits;
import org.springframework.boot.context.properties.ConfigurationProperties;

/// Exposes finite Policy Language compiler limits through application configuration.
@ConfigurationProperties(prefix = "taskmigo.policy.compiler")
public class PolicyCompilerProperties {
