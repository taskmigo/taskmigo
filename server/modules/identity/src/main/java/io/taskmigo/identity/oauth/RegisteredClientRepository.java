    ...
    extends org.springframework.security.oauth2.server.authorization.client.RegisteredClientRepository
{
    ...
    /// Persists a client submitted through the Spring Authorization Server contract as an internal client.
    @Override
    default void save(RegisteredClient registeredClient) {
        this.save(new RegisteredClientDefinition(registeredClient, RegisteredClientType.INTERNAL));
    }
