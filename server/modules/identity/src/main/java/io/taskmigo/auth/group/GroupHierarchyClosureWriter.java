...
@Service
final class GroupHierarchyClosureWriter {

    private final EntityManager entityManager;

    GroupHierarchyClosureWriter(EntityManager entityManager) {
        this.entityManager = entityManager;
    }

    void replace(Collection<GroupEntity> groups, Function<UUID, ? extends Collection<UUID>> reachable) {
