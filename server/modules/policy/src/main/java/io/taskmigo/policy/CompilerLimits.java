...
/// Contains finite safety limits applied before a policy becomes executable.
public record CompilerLimits(
    ...
    public CompilerLimits {
        if (
            ...
            throw new IllegalArgumentException("Policy Language compiler limits must be positive");
        }
    }
