...
///
/// `updatedAt` is persistence metadata, not part of the canonical Statement contract. Persistence adapters must
/// advance it whenever the corresponding Statement row changes so derived execution artifacts can be reused safely.
