...
class HexagonalOnionRulesTest {
    ...
    void shouldRejectApplicationDependencyWhenDomainRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.domainRule(CONTEXT).check(CLASSES)).isInstanceOf(
    ...
    void shouldRejectFrameworkDependencyWhenPlainApplicationServiceRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.plainApplicationServiceRule(CONTEXT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
    ...
    void shouldRejectImplementationDependencyWhenInboundPortRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.inboundPortRule(CONTEXT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
    ...
    void shouldRejectDrivenAdapterDependencyWhenOutboundPortRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.outboundPortRule(CONTEXT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
    ...
    void shouldRejectImplementationDependencyWhenDrivingAdapterRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.drivingAdapterRule(CONTEXT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
    ...
    void shouldRejectImplementationDependencyWhenDrivenAdapterRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.drivenAdapterRule(CONTEXT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
    ...
    void shouldRejectPersistenceFrameworkDependencyWhenContainmentRuleIsChecked() {
        assertThatThrownBy(() ->
            HexagonalOnionRules.persistenceFrameworkContainmentRule(CONTEXT).check(CLASSES)
    ...
    void shouldRejectImplementationDependencyWhenExecutableDrivingAdapterRuleIsChecked() {
        assertThatThrownBy(() -> HexagonalOnionRules.drivingApplicationRule(ROOT).check(CLASSES)).isInstanceOf(
            AssertionError.class
        );
    }
}
